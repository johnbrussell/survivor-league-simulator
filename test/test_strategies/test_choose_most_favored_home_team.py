...
class TestChooseMostFavoredHomeTeam(unittest.TestCase):
    def test_favor_most_favored_home_team(self):
        ...
        team_1 = team.Team(name=1, conference=1, division=1, elo=1250)
        team_2 = team.Team(name=2, conference=2, division=2, elo=1300)
        team_3 = team.Team(name=3, conference=3, division=3, elo=1600)
        team_4 = team.Team(name=4, conference=4, division=4, elo=1400)
        team_5 = team.Team(name=5, conference=5, division=5, elo=1500)
        team_6 = team.Team(name=6, conference=6, division=6, elo=1100)
        ...
        self.assertListEqual(ranked_teams, [team_3, team_5, team_4, team_1, team_2, team_6])
